            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <ul class="list-disc ml-4">
                        ...
                        <li class="text-green-400">
                            Use <span class="line-through">https://github.com/laravel/ui</span> <span class="bold">https://github.com/laravel/breeze</span> as default Bootstrap-based design theme, but remove
                            ability to register
                        </li>
                    </ul>
                </div>
